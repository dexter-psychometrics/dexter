...
the Gibbs sampler that produced the sample of item parameters. Note that we have choosen every fifth sample to get rid of (most of) the autocorelation in the samples of item parameters.
