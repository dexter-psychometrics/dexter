...
The results show a small increase in variance but, with `r nP` persons, the item parameters have been estimated very precisely. Note that the user can accomplish the same goal by calling `plausible_values` without parms.
...
```{r make_pv4, fig.align='center',fig.width=7,par=list(mfrow=c(1,3))}
