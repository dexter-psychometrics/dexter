...
impute_NRM_C <- function(pv, b, a, first, last, person_index, item_first, item_score, by_item, max_cores) {
    .Call(`_dexter_impute_NRM_C`, pv, b, a, first, last, person_index, item_first, item_score, by_item, max_cores)
}
