...
The function `profile_plot` in package dexter produces plots like the following one based on the verbal agression dataset:

```{r, figProf, echo=FALSE, results="hide",out.extra='style="border:none;display:block;margin: 0 auto;"'}
...
```{r, fig1, echo=FALSE, out.extra='style="border:none;"'}
...
```{r, prof_plot2, echo=FALSE, fig.height=5, fig.width=5, fig.align='center', out.extra='style="border:none;display:block;margin: 0 auto;"'}
